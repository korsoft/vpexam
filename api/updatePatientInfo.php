...
try {
    ...
    if (isset($_POST['insurance_group_num'])) {
    ...
    if (isset($_POST['insurance_id_cert_num'])) {
    ...
    if (isset($_POST['insurance_issue_date'])) {
