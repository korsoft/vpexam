...
if (!empty($_POST)) {
    ...
    if ($row) {
        ...
        $response["success"] = 1;
        $response["message"] = "This patient is already in the database";
    ...
    $query = "INSERT INTO patient_information ( first_name, last_name, mrn, D_id, gender ) VALUES ( :first, :last, :mrn, :u_id,:gender ) ";
