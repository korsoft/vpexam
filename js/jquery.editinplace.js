...
(function($) {
	...
	$.fn.editInPlace = function(options) {
		...
		assertMandatorySettingsArePreset(settings);
		preloadImage(settings.save_image);
	...
	$.extend(InlineEditor.prototype, {
		init: function() {
			this.setDefaultTextIfNecessary();
		...
		setDefaultTextIfNecessary: function() {
			if ('' !== this.dom.html())
				return;
		...
		addHoverEffect: function() {
			if (this.settings.hover_class)
				this.dom.addClass(this.setting.hover_class);
			else
		...
		removeInsertedDefaultTextIfNecessary: function() {
