...
$(document).on("ready", function() {
    ...
    $('#historyList').collapsibleList('.header', {
        search: false
    });

    $('#btnExpandAll').on('click', function() {
        $('#historyList').collapsibleList('.header').data('collapsibleList').expandAll();
    });

    $('#btnCollapseAll').on('click', function() {
        $('#historyList').collapsibleList('.header').data('collapsibleList').collapseAll();
    });
