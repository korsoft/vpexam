(function() {
    ...
    VS.ui.SearchBox = Backbone.View.extend({
        ...
        initialize: function(options) {
            ...
            this.facetViews = [];
            this.inputViews = [];
            _.bindAll(this, 'renderFacets', '_maybeDisableFacets', 'disableFacets', 'deselectAllFacets', 'addedFacet', 'removedFacet', 'changedFacet');
        ...
        // Renders the search box, but requires placement in the page through `this.el`.
        render: function() {
        ...
        renderPlaceholder : function() {
            ...
            if (this.app.searchQuery.length)
                ...
                $placeholder.removeClass("VS-hidden").text(this.app.options.placeholder);
        },
