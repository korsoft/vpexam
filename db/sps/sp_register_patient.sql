...
BEGIN 
	...
	INSERT INTO patients(username, email, password, salt, first_name, last_name, dob, phone, old_patient_id ) VALUES(_firstname, _email, _password, _salt, _firstname, _lastname, _dob, _phone, 0);
