...
BEGIN 
    SELECT pat.patient_id AS patientId, pat.username, pat.first_name AS firstName, pat.last_name AS lastName, pat.gender, pat.dob, war.entered_at AS waitingroom, war.uploaded, pat.register_at
    FROM patients pat
