...
<head>
    ...
    <link rel="stylesheet" type="text/css" href="<?php autoVerCss('/style/history.css');?>">
    ...
    <script src="<?php autoVerCss('/js/history.js');?>"></script>
...
<main id="panel">
    <header>
        ...
        <span class="headerText"><?php echo($title); ?></span>
        ...
        <div class="container">
            ...
            <div class="right">
                <div class="controlsDiv">
                    <div class="button-dark" id="btnExpandAll">Expand All</div>
                    <div class="button-dark" id="btnCollapseAll">Collapse All</div>
                </div>
                <div class="historyDiv">
                    <ul id="historyList">
                        <?php
                            for ($i = 0; $i < count($history); $i++) {
                                $descr = $history[$i]->description;
                                $rsp = $history[$i]->patientResponse;
                                if ($rsp === "")
                                    $rsp = "No Response";
                                echo("<li class=\"header\">$descr</li>");
                                echo("<ul>");
                                echo("  <li>$rsp</li>");
                                echo("</ul>");
                            }
