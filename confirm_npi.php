...
<div class="main">
    <h1>Physician Confirmation</h1>
    <br />
    <h2>By checking the box below, I confirm that my name is <?php echo($_POST['fname'] . ' ' . $_POST['lname']) ?>, and I
        am a licensed physician practicing at the following address: <br /><br />
        <?php echo($_POST['addr']) ?><br />
        <?php echo($_POST['city'] . ', ' . $_POST['state'] . '  ' . $_POST['zip']) ?><br /><br />
       I understand that impersonating a physician is against the law.
    </h2>
</div>
<div id="footer">
